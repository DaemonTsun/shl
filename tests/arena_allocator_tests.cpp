...
define_test(alloc_uses_arena_allocator)
{
...

    {
        ...
        s64 *x = allocator_alloc_T(alloc, s64);
...
define_test(free_only_frees_last_alloc)
{
...

    {
        ...
        y = allocator_dealloc_T(alloc, y, s64);
