...
bool parse_string(parser<wchar_t> *p, parse_range *out, parse_error<wchar_t> *err, char delim = L'"', bool include_delims = false);
...
bool parse_int(parser<char> *p, int *out, parse_error<char> *err);
bool parse_int(parser<wchar_t> *p, int *out, parse_error<wchar_t> *err);
bool parse_long(parser<char> *p, long *out, parse_error<char> *err);
bool parse_long(parser<wchar_t> *p, long *out, parse_error<wchar_t> *err);
bool parse_long_long(parser<char> *p, long long *out, parse_error<char> *err);
bool parse_long_long(parser<wchar_t> *p, long long *out, parse_error<wchar_t> *err);
bool parse_unsigned_int(parser<char> *p, unsigned int *out, parse_error<char> *err);
bool parse_unsigned_int(parser<wchar_t> *p, unsigned int *out, parse_error<wchar_t> *err);
bool parse_unsigned_long(parser<char> *p, unsigned long *out, parse_error<char> *err);
bool parse_unsigned_long(parser<wchar_t> *p, unsigned long *out, parse_error<wchar_t> *err);
bool parse_unsigned_long_long(parser<char> *p, unsigned long long *out, parse_error<char> *err);
bool parse_unsigned_long_long(parser<wchar_t> *p, unsigned long long *out, parse_error<wchar_t> *err);
...
bool parse_float(parser<char> *p, float *out, parse_error<char> *err);
bool parse_float(parser<wchar_t> *p, float *out, parse_error<wchar_t> *err);
bool parse_double(parser<char> *p, double *out, parse_error<char> *err);
bool parse_double(parser<wchar_t> *p, double *out, parse_error<wchar_t> *err);
bool parse_long_double(parser<char> *p, long double *out, parse_error<char> *err);
bool parse_long_double(parser<wchar_t> *p, long double *out, parse_error<wchar_t> *err);
